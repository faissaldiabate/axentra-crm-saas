...
```bash
git remote add encore encore://axentra-crm-saas-tydi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/axentra-crm-saas-tydi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/axentra-crm-saas-tydi/settings/integrations/github)
