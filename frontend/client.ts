...
import { get as api_leads_get_get } from "~backend/leads/get";
...
export namespace leads {
    ...
    export class ServiceClient {
         ...
         * Deletes a lead.
         */
        public async deleteLead(params: { id: number }): Promise<void> {
            await this.baseClient.callTypedAPI(`/leads/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
        }

        /**
         * Retrieves a specific lead by ID.
         */
        public async get(params: { id: number }): Promise<ResponseType<typeof api_leads_get_get>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/leads/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_leads_get_get>
        }
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { sendNotification as api_notifications_send_sendNotification } from "~backend/notifications/send";
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { generateWeeklyReport as api_reports_weekly_report_generateWeeklyReport } from "~backend/reports/weekly_report";
...
export namespace reports {
    ...
    export class ServiceClient {
         ...
         */
        public async generateWeeklyReport(params: RequestType<typeof api_reports_weekly_report_generateWeeklyReport>): Promise<ResponseType<typeof api_reports_weekly_report_generateWeeklyReport>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/reports/weekly`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_reports_weekly_report_generateWeeklyReport>
        }
    }
}
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { trackEngagement as api_scoring_track_engagement_trackEngagement } from "~backend/scoring/track_engagement";
...
export namespace scoring {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.trackEngagement = this.trackEngagement.bind(this)
        }

        /**
         * Tracks engagement events for lead scoring.
         */
        public async trackEngagement(params: RequestType<typeof api_scoring_track_engagement_trackEngagement>): Promise<void> {
            await this.baseClient.callTypedAPI(`/scoring/track`, {method: "POST", body: JSON.stringify(params)})
        }
    }
}
